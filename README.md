...
2. Alert when the prices are low
...
docker run --rm --name train_checker -p 8000:8000 -v .:/app train_checker
```

Access the FastAPI automatic documentation [here](http://0.0.0.0:8000/docs).
